...
class Server {
	...
	protected function connect($socket) {
		...
		$client = new \Beech\Socket\Client(uniqid(), $socket);
		$this->clients[] = $client;
		$this->sockets[] = $socket;
	 ...
	 * @param $action
	 */
	protected function action($client, $action) {
	 ...
	 */
	protected function startProcess($client) {
	 ...
	 */
	protected function console($text, $exit = false) {
