...
/**
 */
class Version20121024165057 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE beech_absence_domain_model_registration (persistence_object_identifier VARCHAR(40) NOT NULL, creationdatetime DATETIME NOT NULL, startdatetime DATETIME NOT NULL, enddatetime DATETIME NOT NULL, remark VARCHAR(255) DEFAULT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
		...
		$this->addSql("ALTER TABLE beech_absence_domain_model_absence ADD CONSTRAINT FK_5C6B4E64DF736B67 FOREIGN KEY (createuser) REFERENCES beech_party_domain_model_person (persistence_object_identifier)");
		$this->addSql("ALTER TABLE beech_absence_domain_model_absence ADD CONSTRAINT FK_5C6B4E649E58E94F FOREIGN KEY (personsubject) REFERENCES beech_party_domain_model_person (persistence_object_identifier)");
		$this->addSql("ALTER TABLE beech_absence_domain_model_sicknessabsence ADD CONSTRAINT FK_5FA020D078273F23 FOREIGN KEY (nursinglocation) REFERENCES beech_party_domain_model_address (persistence_object_identifier)");
	}
