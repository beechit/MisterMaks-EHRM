 ...
 */
class UserPreferencesController extends \Beech\Ehrm\Controller\AbstractController {
	...
	public function indexAction() {
		if ($this->securityContext->getAccount()->getParty() instanceof \Beech\Party\Domain\Model\Person) {
			$this->view->assign('locale', $this->securityContext->getAccount()->getParty()->getPreferences()->get('locale'));
		} else {
			$this->view->assign('locale', 'EN_en');
		}
