<?php
/**
 * This file is a copy of dompdf_config.inc.php
 * Original file is part of library and is loaded by composer, so it should't be modified
 */
 ...
 */
define("DOMPDF_DIR", str_replace(DIRECTORY_SEPARATOR, '/', FLOW_PATH_PACKAGES . 'Libraries/dompdf/dompdf/'));
